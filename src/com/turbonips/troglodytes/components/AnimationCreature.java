...
public class AnimationCreature extends Component
{
	...
	public AnimationCreature(SpriteSheet sheet)
	{
		this.sheet = sheet;
		...
		// Row 6 = attackDown
		// Row 7 = attackLeft
		// Idles should be the first frame of a move animation (or maybe should be first frame and animation is frame 2+)
		
		// demoChar is a 4 row sheet, movement and idle only.
		int animationSpeed = 50;
		Image[] moveUpFrames = {this.sheet.getSubImage(1, 2), this.sheet.getSubImage(2, 2), this.sheet.getSubImage(3, 2), this.sheet.getSubImage(4, 2), this.sheet.getSubImage(5, 2), this.sheet.getSubImage(6, 2)};
		Image[] moveRightFrames = {this.sheet.getSubImage(1, 3), this.sheet.getSubImage(2, 3), this.sheet.getSubImage(3, 3), this.sheet.getSubImage(4, 3), this.sheet.getSubImage(5, 3), this.sheet.getSubImage(6, 3)};
		Image[] moveDownFrames = {this.sheet.getSubImage(1, 0), this.sheet.getSubImage(2, 0), this.sheet.getSubImage(3, 0), this.sheet.getSubImage(4, 0), this.sheet.getSubImage(5, 0), this.sheet.getSubImage(6, 0)};
		Image[] moveLeftFrames = {this.sheet.getSubImage(1, 1), this.sheet.getSubImage(2, 1), this.sheet.getSubImage(3, 1), this.sheet.getSubImage(4, 1), this.sheet.getSubImage(5, 1), this.sheet.getSubImage(6, 1)};
